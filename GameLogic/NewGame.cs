...
namespace TamboliyaApi.GameLogic
{
    public class NewGame
    {
        ...
        public async Task<NewGame> GetOracle(NewUserGame newParentGame, Guid userId)
        {
            ...
            this.DateBeginning = GameExtensions.ConverLocalDateToDateOffset(newParentGame.DateBeginning, newParentGame.TimeOffset);
            this.DateEnding = GameExtensions.ConverLocalDateToDateOffset(newParentGame.DateEnding, newParentGame.TimeOffset);
