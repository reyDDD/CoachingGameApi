...
using IIdentityServerInteractionService = IdentityServer4.Services.IIdentityServerInteractionService;
using IClientStore = IdentityServer4.Stores.IClientStore;
using IEventService = IdentityServer4.Services.IEventService;
using ConsentResponse = IdentityServer4.Models.ConsentResponse;
...
namespace TamboliyaApi.Controllers
{
    ...
    public class AccountController : Controller
    {
		...
		public IActionResult Register(string returnUrl)
		{
            ...
            return View(nameof(Register), regModel);
		}
        ...
        public async Task<IActionResult> Register(UserRegistrationModel userModel)
        {
			...
			var roleAdminExist = await _roleManager.RoleExistsAsync("Admin");
			if (!roleAdminExist)
			{
